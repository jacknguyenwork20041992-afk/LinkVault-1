          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <p style="text-align: center;">
                <a href="${fileUrl}" class="button" style="display: inline-block; padding: 12px 25px; background: #0066cc; color: white; text-decoration: none; border-radius: 5px; margin: 10px 0;" title="Click to download student list file">📄 Download Student List (Excel File)</a>
              </p>
              <p style="font-size: 12px; color: #666; text-align: center;">
                <em>Note: The file link will expire in 24 hours for security purposes</em>
              </p>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p style="text-align: center;">
                <a href="${fileUrl}" class="button" style="display: inline-block; padding: 12px 25px; background: #dc3545; color: white; text-decoration: none; border-radius: 5px; margin: 10px 0;" title="Click to download student list file">📄 Download Student List (Excel File)</a>
              </p>
              <p style="font-size: 12px; color: #666; text-align: center;">
                <em>Note: The file link will expire in 24 hours for security purposes</em>
              </p>
